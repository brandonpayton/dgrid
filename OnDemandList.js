...
return declare([List, _StoreMixin], {
	...
	cleanup: function(){
		...
		// TODO: is this needed? it was in the dgrid+dstore prototype
		this.preload = null;
	},
	...
	refresh: function(options){
		...
		if(this._renderedCollection){
			...
			results = self.renderQuery(function(queryOptions){
				console.log("range", queryOptions.start, queryOptions.count);
				// TODO: Remove call to forEach once dstore gets a `then` method
				return self._renderedCollection.range(queryOptions.start, queryOptions.start + queryOptions.count).forEach(function(){});
			});
			if(typeof results === "undefined"){
